/*!
 * lunar-javascript (vendored, unmodified)
 * https://github.com/6tail/lunar-javascript
 * Licensed under the MIT License — see ./LICENSE-lunar-javascript
 * Used here purely as a calculation engine (solar/lunar conversion, jieqi,
 * sexagenary year/month/day/hour indices). All Korean text, styling and
 * interpretation logic in this app are original and layered on top via
 * ../js/saju.js, which only reads numeric indices from this library.
 */
